function specialFunction(cat) {
  ...
  function unicorn() {
      ...
      '@keyframes launch {0% {transform: none;} 100% {transform:none;}}';
  ...
  function scaredyCat() {
    ...
    mouseArea.style = `width:${scareAreaSize}px;height:${scareAreaSize}px;border-radius:50%;display:flex;justify-content:center;align-items:center;`;
    ...
    function actScared(e) {
      ...
      btn.addEventListener('animationend', removeCatButton);
      btn.addEventListener('click', removeCatButton);
    }
